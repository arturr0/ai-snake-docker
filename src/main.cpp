...
const int MAX_TRAINING_EPISODES = 10000;
...
void initSDL() {
    ...
    if (!screen) {
        cerr << "SDL_GetWindowSurface Error: " << SDL_GetError() << '\n';
